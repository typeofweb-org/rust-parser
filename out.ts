...
export type PrismaErrors = InputValueTooLong | RecordNotFound | UniqueKeyViolation | ForeignKeyViolation | ConstraintViolation | StoredValueIsInvalid | TypeMismatch | TypeMismatchInvalidCustomType | QueryParsingFailed | QueryValidationFailed | RawQueryFailed | NullConstraintViolation | MissingRequiredValue | MissingRequiredArgument | RelationViolation | RelatedRecordNotFound | InterpretationError | RecordsNotConnected | ConnectedRecordsNotFound | InputError | ValueOutOfRange | TableDoesNotExist | ColumnDoesNotExist | InconsistentColumnData | PoolTimeout | RecordRequiredButNotFound | UnsupportedFeature | MultiError | InteractiveTransactionError | QueryParameterLimitExceeded | MissingFullTextSearchIndex | MongoReplicaSetRequired | MissingFieldsInModel | ValueFitError;

export enum PrismaErrorCode {InputValueTooLong = "P2000",
